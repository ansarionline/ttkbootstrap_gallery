...
class MouseUtilities(ttk.Frame):
    ...
    def __init__(self, *args, **kwargs):
        ...
        ttk.Button(dev_info_header, style='Link.TButton', command=self.callback).pack(side='left')
        ttk.Label(dev_info_header, text='Model 2009, 2xAA Batteries').pack(side='left', fill='x', padx=15)
        ttk.Button(dev_info_header, style='Link.TButton', command=self.callback).pack(side='left')

        ### image
        ttk.Label(dev_info).pack(fill='x')
        ...
        buy_now = ttk.Button(lic_info, text='Buy now', compound='bottom', command=self.callback)
        ...
        ttk.Button(op2, style='Link.TButton', command=self.callback).pack(side='right')

        ### inverse
        op3 = ttk.Checkbutton(scrolling, text='Inverse scroll directcion vertically', variable='op3')
        op3.pack(fill='x', padx=(20, 0), pady=5)
        ttk.Button(op3, style='Link.TButton', command=self.callback).pack(side='right')
        ...
        ttk.Button(op5, style='Link.TButton', command=self.callback).pack(side='right')
        ...
        scroll_speed_btn = ttk.Button(scroll_speed_frame, style='Link.TButton')
        ...
        scroll_sense_btn = ttk.Button(scroll_sense_frame, style='Link.TButton')
        ...
        gest_sense_btn = ttk.Button(gest_sense_frame, style='Link.TButton')
        ...
        two_finger_sense_btn = ttk.Button(two_finger_sense_frame, style='Link.TButton')
        ...
        base_speed_sense_btn = ttk.Button(base_speed_sense_frame, style='Link.TButton')
